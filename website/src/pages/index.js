...
const features = [
  {
    content: (
      <p>
        Flutter is Google’s UI toolkit for building beautiful, natively compiled applications for <b>Mobile</b> from a single codebase.
      </p>
    ),
    image: (
  ...
  },
  {
    content: (
      <p>
        Flutter is Google’s UI toolkit for building beautiful, natively compiled applications for <b>Desktop</b> from a single codebase.
      </p>
    ),
    image: (
  ...
  },
  {
    content: (
      <p>
        Flutter is Google’s UI toolkit for building beautiful, natively compiled applications for <b>Web</b> from a single codebase.
      </p>
    ),
    image: (
